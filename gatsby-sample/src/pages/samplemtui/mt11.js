...
export default function ContextMenu() {
  ...
  const handleClick = event => {
    ...
    console.log(event.currentTarget.id, qq);
    
    if ( event.currentTarget.id == 'me' ){
        //setFlag(1);
        qq = 1;
  ...
  return (
    <div id="all" onContextMenu={handleClick} style={{ cursor: 'context-menu' }}>
        <div id="me" onContextMenu={handleClick} style={{ cursor: 'context-menu' }}>
        <Typography>
